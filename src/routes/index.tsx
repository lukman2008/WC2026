...
import { Trophy, Ticket, MapPin, ArrowRight, Shield, Zap, Globe } from "lucide-react";
      ...
      <section className="relative overflow-hidden bg-gradient-hero">
        ...
        <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-24 sm:py-32 lg:py-40">
          <div className="text-center max-w-3xl mx-auto">
            ...
            >
              <span className="text-foreground">Your Seat at the</span>
              <br />
            ...
            >
              Secure your tickets for the biggest sporting event on the planet. 
            ...
            >
              <Link
                to="/matches"
                className="inline-flex items-center gap-2 rounded-xl bg-gradient-primary px-7 py-3.5 text-sm font-bold text-primary-foreground shadow-glow-primary transition-all hover:opacity-90 hover:scale-[1.02]"
              >
      ...
      <section className="py-16 sm:py-20">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="flex items-end justify-between mb-8">
            ...
            <Link to="/matches" className="text-sm font-semibold text-primary hover:underline hidden sm:block">
              View all matches →
            </Link>
          </div>
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="relative overflow-hidden rounded-2xl border border-primary/20 bg-gradient-hero p-10 sm:p-14 text-center">
            ...
            <div className="relative">
              ...
              <Link
                to="/matches"
                className="mt-6 inline-flex items-center gap-2 rounded-xl bg-gradient-primary px-7 py-3.5 text-sm font-bold text-primary-foreground shadow-glow-primary transition-all hover:opacity-90 hover:scale-[1.02]"
              >
                <Ticket className="h-4 w-4" />
                Get Your Tickets
              </Link>
